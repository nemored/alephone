...
public:
	...
	std::shared_ptr<StreamPlayer> PlayStream(CallBackStreamPlayer callback, int rate, bool stereo, AudioFormat audioFormat, float initialGain = 1.0f, bool shouldRoutinelyStop = true);
